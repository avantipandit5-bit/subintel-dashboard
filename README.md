...
**[Live Demo →](https://avantipandit5-bit.github.io/subintel-dashboard/)**
...
1. **Open the dashboard:** [Live Demo](https://avantipandit5-bit.github.io/subintel-dashboard/) or download `index.html` and open in any browser
